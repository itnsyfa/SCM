              ...
              <div class="card-body">
                <form role="form" class="text-start" role="form" method="post">
                  <div class="input-group input-group-outline my-3">
                    ...
                    <input type="text" class="form-control" placeholder="Usrname" name="user">
                  </div>
                  ...
                  <p class="mt-4 text-sm text-center">
                    Login sebagai
                    <a href="../customer/login.php" class="text-primary text-gradient font-weight-bold">Customer</a> |
