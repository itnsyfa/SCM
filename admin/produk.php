  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-12">
          <?php 
              $ambildatastock =$koneksi->query("SELECT * FROM produk where stok_produk < 5");
              ...
              while($fetch=mysqli_fetch_array($ambildatastock)){
                ...
                echo "<div class='alert alert-danger alert-dismissible'>
                  ...
                  <strong>Perhatian!</strong> Stock Barang <?php echo$barang;?> dibawah Batas Minimum
                </div>";
              }
          ?>
          <br>
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <center><a href="tambahproduk.php" class="btn btn-primary" > Tambah Data</a></center>
              </div>
            </div>
          </div>
        </div>
