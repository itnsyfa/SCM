...
<body class="bg-gray-200">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" class="text-start" role="form" method="post">
                  ...
                  <button class="btn bg-gradient-primary w-100 my-4 mb-2" name="simpan">Sign in</button>
                  <p class="mt-4 text-sm text-center">
                    Tidak Memiliki Akun?
                    <a href="signup.php" class="text-primary text-gradient font-weight-bold">Sign up</a><br>
                    Login sebagai
                    <a href="../admin/login.php" class="text-primary text-gradient font-weight-bold">Admin</a> |
                    <a href="../supplier/login.php" class="text-primary text-gradient font-weight-bold">Supplier</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                "Intan Syifa Reflis & Miftahul Jannah Parinduri".
              </div>
            </div>
  ...
  if (isset($_POST["simpan"])) {
    ...
    $ambil = $koneksi->query("SELECT * FROM customer
      WHERE email_customer='$email' AND password_customer='$password'");
