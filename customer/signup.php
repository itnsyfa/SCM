              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" method="post">
                    ...
                    <button class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0" name="save">Sign Up</button>
                  </form>
  ...
  <?php
        if (isset($_POST['save'])) {
            $koneksi->query("INSERT INTO customer
                (email_customer,password_customer,nama_customer,telp_customer)
                VALUES('$_POST[email]','$_POST[password]','$_POST[nama]','$_POST[telp]')");
